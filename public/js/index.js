...
window.Echo.channel('live-monitor').listen('.finished.check', function (e) {
  ...
  var element = document.querySelector("#".concat(id, " .").concat(type));
  element.textContent = last_run_message;
  element.classList.remove('text-success text-danger text-warning');
  element.classList.add(element_class);
  element = document.querySelector("#".concat(host_id));
  element.textContent = "Last update: ".concat(last_update); // $(`#${id} .${type}`)
